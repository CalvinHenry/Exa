...
public class Constants {
	public static ArrayList<Message> convertArrayListToMessage(ArrayList<Entity> list){
	...
	public static ArrayList<Entity> convertArrayListToEntity(ArrayList<Message> list){
